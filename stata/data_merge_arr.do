...
foreach v of local airports{
	...
	append using "F:\Dropbox\Flight\Data\time_`v'.dta" 
	...
	merge m:1 id using "F:\Dropbox\Flight\Data\weather_`v'.dta"
	
		
	
	save "F:\Dropbox\Flight\Data\data_`v'_arr.dta",replace
}
